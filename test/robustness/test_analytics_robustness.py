...
def test_analytics_division_by_zero_protection(database_paths: tuple[str, str]) -> None:
...
@pytest.mark.parametrize(
    "poisoned_pnl", [float("nan"), float("inf"), -float("inf"), 1e20]
)
def test_analytics_handles_poisoned_data(
    database_paths: tuple[str, str], poisoned_pnl: float
) -> None:
