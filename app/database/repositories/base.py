...
class BaseRepository:
    ...
    def execute(self, sql: str, params: tuple = (), conn: sqlite3.Connection = None) -> sqlite3.Cursor:
        """
    ...
    def fetch_one(self, sql: str, params: tuple = (), conn: sqlite3.Connection = None) -> sqlite3.Row | None:
    ...
    def fetch_all(self, sql: str, params: tuple = (), conn: sqlite3.Connection = None) -> list[sqlite3.Row]:
    ...
    def fetch_val(self, sql: str, params: tuple = (), conn: sqlite3.Connection = None) -> Any:
