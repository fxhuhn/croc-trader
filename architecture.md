...
- **Backtesting System** ([app/services/backtester/](app/services/backtester/)): Simulates custom strategies on historical market databases, generating performance logs and data visualizations.
