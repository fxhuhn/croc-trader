...
* **Web Views & Controllers:** `create_app`, `health_check`, `to_local_tz`, `favicon`, `robots_txt`, `apple_touch_icon`, `apple_touch_icon_precomposed`, `inject_last_updated`, `set_global_last_updated`, `view_analytics_dashboard`, `view_backtest_dashboard`, `view_broker_dashboard`, `view_concept2_test`, `view_screener_croc`, `view_screener_dip_buyer`, `view_screener_ndx_momentum`, `view_screener_overview`, `view_screener_turnover`, `view_screener_twopercent`, `view_trades_croc`, `view_trades_dip_buyer`, `view_trades_ndx_momentum`, `view_trades_overview`, `view_trades_turnover`, `view_trades_twopercent`
