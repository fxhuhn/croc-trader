...
1. **Activate the Strategy-Screener Skill**: Load and execute the instructions in [.agent/skills/strategy-screener/SKILL.md](.agent/skills/strategy-screener/SKILL.md).
