...
1. **Activate the Architect Workflow Skill**: Load and execute the instructions in [.agents/skills/architect-workflow/SKILL.md](.agents/skills/architect-workflow/SKILL.md).
